/*! For license information please see main.6b95fec3.js.LICENSE.txt */
!(function () {
  "use strict";
  var e = {
      470: function (e, n, t) {
  ...
  !(function () {
    ...
    var m = t(559),
      v = (function (n) {
        ...
        function l() {
          ...
          return (
            e(this, l),
            ((n = t.call(this)).searchRef = c.createRef()),
            (n.state = { showingSearch: !1, searchText: "", results: [] }),
            n
          );
        }
        return (
          r(l, [
            ...
            },
            {
              ...
              value: function (e) {
                var n = this;
                fetch("/.netlify/functions/api/search" + "/?query=".concat(e), {
                  method: "GET",
                })
                  .then(function (e) {
                    return e.json();
                  ...
                  .then(function (e) {
                    return n.setState(h(h({}, n.state), {}, { results: e }));
                  })
                  .catch(function (e) {
                    console.error(e);
                  });
            ...
            },
            {
              ...
              value: function (e) {
                ...
                0 !== n.length && n.length >= 3
                  ? (function (e, n) {
                      var t = null;
                    })(this.searchFetch(n), 500)
                  : this.setState(h(h({}, this.state), {}, { results: [] }));
              },
            },
            {
              key: "render",
                          ...
                          (0, m.jsxs)("nav", {
                            children: [
                              ...
                              (0, m.jsx)("a", {
                                href: "#",
                                onClick: function (e) {
                                  return t.hideSearchContainer(e);
                                },
                                children: (0, m.jsx)("i", {
                                  ...
                                  "div",
                                  {
                                    ...
                                    children: [
                                      (0, m.jsxs)("a", {
                                        ...
                                        href: "/product_".concat(e._id),
                                        children: [
                                          (0, m.jsx)("img", {
                                            alt: "".concat(e.name),
                                            src: "".concat(e.picture),
                                          }),
                                          (0, m.jsx)("div", {
                                            className:
                                          ...
                                          (0, m.jsxs)("div", {
                                            className: "header-search_price",
                                            children: ["$", e.price],
                                          }),
                                        ],
                                      }),
                                      (0, m.jsx)("div", {
                                        className: "header-search_tags",
                                        children: e.tags.map(function (e) {
                                          return (0,
                                          m.jsx)("a", { href: "/filter_".concat(e), children: (0, m.jsx)("div", { className: "header-search__result__tag", children: e }) });
                                        }),
                                      }),
                                    ],
                                  },
      ...
      g = (function (n) {
        ...
        var t = s(l);
        function l() {
          return e(this, l), t.apply(this, arguments);
        }
        return (
          r(l, [
            {
    ...
    f.render((0, m.jsx)(b, {}), document.getElementById("root"));
  })();
})();
//# sourceMappingURL=main.6b95fec3.js.map
