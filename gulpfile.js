...
const _devFolder = config.development_folder || ".";
...
function watchTask() {
  gulp.watch(
    ["./src/scripts/**/*.jsx", "./src/scripts/**/*.js"],
    gulp.series(scripts, browserSyncReload)
  );
  gulp.watch(["./src/**/*.scss"], gulp.series(sassTask, browserSyncReload));
  gulp.watch(
    ["./src/**/*.mustache", "./src/**/*.json", "./src/**/*.html"],
